...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="w-full px-6 py-5 md:px-16 flex items-center justify-between bg-transparent absolute top-0 left-0 z-50">
      ...
      <div className="hidden md:flex items-center space-x-8">
        ...
        <Button 
          onClick={handleLogin}
          className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors text-sm font-medium tracking-wide"
        >
          登录
        </Button>
      </div>
